...
api = `https://api.openweathermap.org/data/2.5/weather?q=${city}&units=metric&appid=293e48c4e4bc1e64a6e8427265ee1051`;
fetchData();
};
...
api = `https://api.openweathermap.org/data/2.5/weather?lat=${latitude}&lon=${longitude}&units=metric&appid=293e48c4e4bc1e64a6e8427265ee1051`;
fetchData();
};
